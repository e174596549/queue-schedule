...
class KafkaProducer extends EventEmitter {
     ...
     * @param {TopicItem[]|undefined} option.topicList A list of topic items , which you can send a message to all of the topic in the list. When this parameter passed, the `option.topic` and `option.partition` will be ignored.
